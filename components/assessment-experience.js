...
function ResultsView({ responses, onEdit }) {
  ...
  const gaps = useMemo(() => generatePriorityGaps(results), [results]);
  const nextSteps = useMemo(() => generateNextSteps(results), [results]);
  const roadmap = useMemo(() => generateRoadmap(results), [results]);
    ...
    <div className="grid" style={{ gap: 24 }}>
      <div className="card" style={{ padding: 28 }}>
        <SectionHeader
          ...
          description="A strategic view of organizational readiness across governance, people, workflows, infrastructure, and trust."
        ...
        <div className="grid" style={{ gridTemplateColumns: '280px 1fr', marginTop: 28, alignItems: 'center' }}>
          ...
          <div className="grid" style={{ gridTemplateColumns: 'repeat(3, minmax(0, 1fr))' }}>
            ...
            <StatCard label="Archetype" value={results.archetype.label} helper={results.archetype.description} />
      ...
      <div className="export-sheet">
        ...
        <div className="grid" style={{ gridTemplateColumns: '260px 1fr', alignItems: 'start' }}>
          <div className="panel" style={{ padding: 18 }}>
            ...
            <div style={{ marginTop: 10 }}><Pill tone="blue">{results.maturity.label}</Pill></div>
          </div>
          <div className="panel" style={{ padding: 18 }}>
...
export default function AssessmentExperience() {
  ...
  useEffect(() => {
    const saved = getInitialResponses();
    setResponses(saved);
  }, []);
        ...
        <div className="container grid" style={{ gap: 28 }}>
          <div className="card" style={{ padding: 34 }}>
            ...
            <div className="grid" style={{ gridTemplateColumns: '1.15fr 0.85fr', alignItems: 'center', marginTop: 22 }}>
              ...
              <div className="panel" style={{ padding: 24 }}>
                <div style={{ fontSize: 14, fontWeight: 700, color: '#1d4ed8', marginBottom: 16 }}>What you receive</div>
                <ul className="list-clean">
                  {[
                    'Overall AI Readiness Score (0–100)',
                    'Executive maturity tier and archetype',
          ...
          <div id="product-overview" className="grid" style={{ gridTemplateColumns: 'repeat(3, minmax(0, 1fr))' }}>
            <StatCard label="Audience" value="Executives" helper="Designed for CEOs, CIOs, CTOs, school leaders, operations teams, and mission-driven organizations." />
            ...
            <StatCard label="Experience" value="Premium MVP" helper="Structured for future export, reuse, and customization through config-driven content." />
          </div>
        </div>
      </div>
    );
    ...
    return (
      <div className="page-shell">
        <div className="container">
          ...
          <ResultsView responses={responses} onEdit={() => setShowResults(false)} />
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="page-shell">
      <div className="container grid" style={{ gap: 22 }}>
        <div className="card" style={{ padding: 28 }}>
          <SectionHeader
            eyebrow="Multi-step readiness assessment"
